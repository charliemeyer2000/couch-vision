...
help:
	...
	@echo "  make teleop-test              Test gamepad without BLE (dry-run, viz on :4201)"
	@echo "  make teleop-list              List detected game controllers"
	@echo "  make ble-relay                BLE relay only (localhost:4200)"
	...
	@echo ""
	@echo "LOGS"
	@echo "  make logs                     All container logs"
	@echo "  make logs-bridge              iOS bridge"
	@echo "  make logs-nav2                Nav2 + perception"
	@echo "  make logs-vesc                VESC motor driver"
	@echo "  make logs-ble                 BLE bridge"
	@echo ""
	@echo "ROS2 DEBUGGING"
	...
	@echo ""
	@echo "DEVELOPMENT"
	@echo "  make bridge                   iOS→ROS2 TCP bridge (no Docker)"
...
build-extension:
	...
	cd foxglove/gamepad-relay-panel && pnpm install && pnpm build

install-extension:
	cd foxglove/nav-control-panel && pnpm local-install
	cd foxglove/hardware-safety-panel && pnpm local-install
	cd foxglove/gamepad-relay-panel && pnpm local-install
